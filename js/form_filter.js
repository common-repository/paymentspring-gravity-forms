...
function card_fields_hidden () {
    return !(jQuery("#gform_{$form_id} #input_{$form_id}_{$cc_field_id}_1").is(":visible")
              && jQuery("#gform_{$form_id} #input_{$form_id}_{$cc_field_id}_2_month").is(":visible")
              && jQuery("#gform_{$form_id} #input_{$form_id}_{$cc_field_id}_2_year").is(":visible")
              && jQuery("#gform_{$form_id} #input_{$form_id}_{$cc_field_id}_3").is(":visible")
              && jQuery("#gform_{$form_id} #input_{$form_id}_{$cc_field_id}_5").is(":visible"));
}
